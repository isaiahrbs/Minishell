...
SRCS = lexing/get_input.c lexing/tokenize.c lexing/init_type.c \
	...
	signals/signals.c functions/strings/ft_strjoin.c builtins/cd_utils.c \
	...
	executing/handle_exit.c functions/strings/ft_atoi.c functions/strings/ft_split_utils2.c
